...
namespace emphshell {
    class AppEntry: public QObject {
        Q_OBJECT
        QML_ELEMENT
        QML_UNCREATABLE("AppEntry is not creatable")
    ...
    class AppDb : public QObject {
        ...
        Q_PROPERTY(QQmlListProperty<emphshell::AppEntry> apps READ apps NOTIFY appsChanged)
    ...
    public:
        ...
        Q_INVOKABLE QQmlListProperty<AppEntry> getFilteredApps(const QString& filter, const qint32 maxResults);
    ...
    private:
        ...
        QList<AppEntry*>& sortApps(QList<AppEntry*>& unsortedApps) const;
