//https://github.com/end-4/dots-hyprland/blob/fbfb81c83bd96e968ba29a59eb799c666bff8ded/dots/.config/quickshell/ii/services/Weather.qml
pragma Singleton
...
Singleton {
    ...
    readonly property int update_interval: Config.options.weather.update_interval * 60 * 1000
    readonly property string city: Config.options.weather.city
    property bool gps_enabled: Config.options.weather.gps_enabled
    ...
    PositionSource {
        id: positionSource
        updateInterval: root.update_interval
        ...
        onPositionChanged: {
            ...
            if (position.latitudeValid && position.longitudeValid) {
                ...
                root.gps_enabled = root.location.valid ? true : false;
    ...
    Timer {
        running: !root.gps_enabled
        repeat: true
        interval: root.update_interval
        triggeredOnStart: !root.gps_enabled
